...
<head>
	...
	<link rel="stylesheet" href="/board7/css/board.css">
...
<body>
	<div id="back-clear" class="div01">
		<div id="center">
			...
			<table class="list-thread">
				...
				<tbody>
					<c:forEach var="thread" items="${threads}" varStatus="status">
						<tr>
							<td class="thread-td">
								<a href="http://localhost:8080/board7/resservlet?threadID=${thread.threadID}"><c:out value="${thread.threadID}"></c:out></a>
							</td>
						
							<td class="thread-td">
								<a href="http://localhost:8080/board7/resservlet?threadID=${thread.threadID}"><c:out value="${thread.title}"></c:out></a>
							</td>
			...
			<div id="page-jump">
				<a href="http://localhost:8080/board7/genreservlet">
				</a>
			</div>
			<div id="page-top">
				<a href="#">
