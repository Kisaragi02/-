...
<body>
	<div id="back-clear" class="div01">
		<div id="center">
			<h1 class="title">
				<a href="http://localhost:8080/board7/threadservlet?genre=hobby" class="thread-button">
					Genre1 Hobby
				</a>
			</h1>
			<p class="Newest">
			...
			<h1 class="title">
				<a href="http://localhost:8080/board7/threadservlet?genre=other" class="thread-button">
					Genre2 Other
				</a>
			</h1>
